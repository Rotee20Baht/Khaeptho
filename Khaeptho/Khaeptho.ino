...
bool postJsonToWebService(float water, float humidity, float temperature,int moisture, bool motor) {
...
void loop() {
  if ((millis() - lastTime) > timerDelay) {
    ...
    while(1){
       bool isSendSuccess = postJsonToWebService(distance, humidity, temperature, moisture, motor);
